document.addEventListener("DOMContentLoaded", function(event) {
  ...
  svg.append("text")
     ...
     .attr("x", w)
     .attr("y", h-6)
     .text("Countries, color coded by region");
  ...
  function populate(error, nations, auroville) {
   ...
   function legend(){
     ...
     svg.append("g")
       .attr("class", "legend")
       .attr("transform", "translate("+(w+10)+","+(230)+")");
   ...
   svg.append("g")
    ...
    var dot=svg.append("g")
               ...
               .on("mouseover", function(d){
                 ...
                 svg.selectAll(".country, .topleftlabel").filter("."+d.name+", .Auroville").style("opacity",1);
                 ...
                 svg.selectAll(".countryGraph").filter("."+d.name+", .Auroville").style("opacity", 0.8);
